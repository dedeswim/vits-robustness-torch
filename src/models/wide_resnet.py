...
class WideResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv2d(in_chans, nChannels[0], kernel_size=3, stride=1, padding=1, bias=False)
        # 1st block
    ...
    def reset_classifier(self, num_classes, global_pool=''):
        ...
        self.head = nn.Linear(self.nChannels, num_classes) if num_classes > 0 else nn.Identity()
